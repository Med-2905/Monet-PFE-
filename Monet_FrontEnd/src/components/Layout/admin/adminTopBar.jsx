    ...
    <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/90 backdrop-blur dark:border-slate-800 dark:bg-slate-950/90">
      <div className="flex h-16 items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden sm:block">
          <p className="text-sm font-bold text-slate-950 dark:text-white">Admin Console</p>
          <p className="text-xs text-slate-500 dark:text-slate-400">Manage doctors, patients, cities, specialties, and profile settings.</p>
        </div>
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          <div className="hidden items-center gap-2 rounded-xl border border-slate-200 px-3 py-2 dark:border-slate-800 md:flex">
            ...
            <span className="max-w-40 truncate text-sm font-semibold">{fullName(user)}</span>
          </div>
